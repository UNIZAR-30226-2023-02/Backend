    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creador_username', models.ForeignKey(db_column='creador_username', on_delete=django.db.models.deletion.CASCADE, related_name='creador_sala', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Sala',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_sala', models.ForeignKey(db_column='nombre_sala', on_delete=django.db.models.deletion.CASCADE, related_name='usuarios_sala_usuario_nombre_sala', to='sala.sala')),
                ('username', models.ForeignKey(db_column='username', on_delete=django.db.models.deletion.CASCADE, related_name='usuarios_sala_usuario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
