    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_partida', models.ForeignKey(db_column='id_partida', on_delete=django.db.models.deletion.CASCADE, related_name='id_partida', to='partida.partida')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('casilla_actual', models.ForeignKey(db_column='casilla_actual', on_delete=django.db.models.deletion.CASCADE, related_name='tablero_ac', to='partida.casilla_tematica')),
                ('casilla_nueva', models.ForeignKey(db_column='casilla_nueva', on_delete=django.db.models.deletion.CASCADE, related_name='tablero_nu', to='partida.casilla_tematica')),
            ],
            options={
                'db_table': 'Tablero',
