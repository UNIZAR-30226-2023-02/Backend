# Generated by Django 4.1.7 on 2023-04-15 10:44
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="user_id",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="amigos_username_id",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("nombre_sala", "user_id"), name="usuario_sala_pk"
            ),
        ),
        migrations.AddConstraint(
            model_name="historico",
            constraint=models.UniqueConstraint(
                fields=("id_partida", "user_id"), name="historico_pk"
            ),
        ),
        migrations.AddConstraint(
            model_name="amigos",
            constraint=models.UniqueConstraint(
                fields=("user_id", "amigo_id"), name="amigos_pk"
            ),
        ),
        migrations.AddConstraint(
            model_name="adquirido",
            constraint=models.UniqueConstraint(
                fields=("user_id", "id_objeto"), name="adquirido_pk"
            ),
        ),
    ]
