# Generated by Django 4.1.7 on 2023-04-16 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('T', 'Tablero'), ('F', 'Ficha')], max_length=7)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('C', 'Clasico'), ('E', 'Equipo'), ('D', 'Desafio'), ('T', 'Tematico')], max_length=50)),
            ],
            options={
                'db_table': 'Partida',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creador_id', models.ForeignKey(db_column='creador_id', on_delete=django.db.models.deletion.CASCADE, related_name='creador_sala', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Sala',
            },
        ...
        migrations.CreateModel(
            name='Tematica',
            fields=[
                ('tema', models.CharField(default='NO_ESPECIFICADO', max_length=100, primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'Tematica',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='usuarios_sala_usuario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('casilla_actual', models.IntegerField()),
                ('tirada_dado', models.IntegerField()),
                ('casilla_nueva', models.IntegerField()),
            ],
            options={
                'db_table': 'Tablero',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tema', models.ForeignKey(default='NO_ESPECIFICADO', on_delete=django.db.models.deletion.CASCADE, to='trivial_api.tematica')),
            ],
            options={
                'db_table': 'Pregunta',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipo', models.CharField(choices=[('E1', 'Equipo1'), ('E2', 'Equipo2'), ('E3', 'Equipo3')], max_length=15)),
                ('id_partida', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historico_id_partida', to='trivial_api.partida')),
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='historico_username', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Historico',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='estadisticas_username', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amigo_id', models.ForeignKey(db_column='amigo_id', on_delete=django.db.models.deletion.CASCADE, related_name='amigos_amigo_id', to=settings.AUTH_USER_MODEL)),
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='amigos_username_id', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Amigos',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_objeto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='adquirido_id_objeto', to='trivial_api.fichas_tableros')),
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='adquirido_username', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Adquirido',
            },
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('nombre_sala', 'user_id'), name='usuario_sala_pk'),
        ),
        migrations.AddConstraint(
            model_name='historico',
            constraint=models.UniqueConstraint(fields=('id_partida', 'user_id'), name='historico_pk'),
        ),
        migrations.AddConstraint(
            model_name='amigos',
            constraint=models.UniqueConstraint(fields=('user_id', 'amigo_id'), name='amigos_pk'),
        ),
        migrations.AddConstraint(
            model_name='adquirido',
            constraint=models.UniqueConstraint(fields=('user_id', 'id_objeto'), name='adquirido_pk'),
        ),
    ]
