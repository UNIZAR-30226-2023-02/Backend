    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_usuario', models.ForeignKey(db_column='id_usuario', on_delete=django.db.models.deletion.CASCADE, related_name='id_usuario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Tiene',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_jugador', models.ForeignKey(db_column='id_jugador', on_delete=django.db.models.deletion.CASCADE, related_name='id_jugador', to=settings.AUTH_USER_MODEL)),
